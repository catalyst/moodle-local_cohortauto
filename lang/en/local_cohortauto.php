...
$string['delim_help'] = 'Different Operating Systems use different end of line delimiters.<br>This is usually CR+LF for Windows, and LF for Linux/MacOS systems.<br>If the plugin does not work with the current setting, experiment with other values.';
